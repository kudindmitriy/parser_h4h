...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <!-- End Header Area -->
        <!-- Start Banner Area -->
        <section class="breadcrumb-area about-page" data-overlay="5" style="background-image: url(img/routes_home.jpg); background-position: bottom;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    @foreach($routes as $route)
                        ...
                        <div class="single-package mb-50">
                            <div class="package-img"  style="max-height: 300px; overflow:hidden;" >
                                <img src="{{asset('storage/'. $route['featured_image'])}}" alt="package image">
                                @if(! empty($route['price']))
                                    <div class="package-cost">{{$route['price']}} грн.</div>
                                @endif
                            </div>
                            <h5><span>{{$route['title']}}</span></h5>
                            <p>{{substr($route['description'], 0, 30). "... "}}</p>
                            <a class="read-more" href="/route/{{$route['id']}}">Бiльше <i class="icofont icofont-arrow-right"></i></a>
                        </div>
